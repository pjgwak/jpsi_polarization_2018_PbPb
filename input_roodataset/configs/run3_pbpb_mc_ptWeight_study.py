...
# set configurations
input_path = '../../input_flowskim/roots/OniaFlowSkim_isMC1_Run3PbPb_Minbias.root'
...
# --- comments ---
# Written: 250717
# The output will be used for mc mass fit w.r.t. mass fit for pT weighting
# no weight mc mass fit - (output of this code)
#    -> no weight mass fit
#    -> dn/dpT