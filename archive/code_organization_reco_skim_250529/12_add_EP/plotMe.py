...
# plotMeMCRun3Overlay.plotOverlaid(fileName='OniaFlowSkim.MC2023.AlgRun3MCReco.root', baseName = 'MCRun3PbPb', formats=['png'], sampleInfo='PbPb MC 2023', isWeight=True)
