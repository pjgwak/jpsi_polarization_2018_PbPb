...
// Thu May 29 17:31:07 2025 by ROOT version 6.32.02
// from TTree myTree/My TTree of dimuons
// found on file: /work/pjgwak/oniatree_5p36/2023_PbPb/OniaTree_RawPrime0_Run3_PbPb_no_track_250520/HIPhysicsRawPrime0/crab_OniaTree_RawPrime0_Run3_PbPb_no_track_250520/250520_121505/Oniatree_MC0_PbPb_2023.root
//////////////////////////////////////////////////////////

#ifndef Run3_tree_branches_h
#define Run3_tree_branches_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Run3_tree_branches(TTree *tree=0);
   virtual ~Run3_tree_branches();
...
#ifdef Run3_tree_branches_cxx
Run3_tree_branches::Run3_tree_branches(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/work/pjgwak/oniatree_5p36/2023_PbPb/OniaTree_RawPrime0_Run3_PbPb_no_track_250520/HIPhysicsRawPrime0/crab_OniaTree_RawPrime0_Run3_PbPb_no_track_250520/250520_121505/Oniatree_MC0_PbPb_2023.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/work/pjgwak/oniatree_5p36/2023_PbPb/OniaTree_RawPrime0_Run3_PbPb_no_track_250520/HIPhysicsRawPrime0/crab_OniaTree_RawPrime0_Run3_PbPb_no_track_250520/250520_121505/Oniatree_MC0_PbPb_2023.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/work/pjgwak/oniatree_5p36/2023_PbPb/OniaTree_RawPrime0_Run3_PbPb_no_track_250520/HIPhysicsRawPrime0/crab_OniaTree_RawPrime0_Run3_PbPb_no_track_250520/250520_121505/Oniatree_MC0_PbPb_2023.root:/hionia");
...
Run3_tree_branches::~Run3_tree_branches()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run3_tree_branches::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run3_tree_branches::LoadTree(Long64_t entry)
{
...
void Run3_tree_branches::Init(TTree *tree)
{
...
bool Run3_tree_branches::Notify()
{
...
void Run3_tree_branches::Show(Long64_t entry)
{
...
Int_t Run3_tree_branches::Cut(Long64_t entry)
{
...
#endif // #ifdef Run3_tree_branches_cxx
