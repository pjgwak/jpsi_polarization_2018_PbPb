...
# draw and save
plotMass.draw()
plotMass.save('figs/overlaid/mass', formats=formats)
...
# draw and save
plotPhi.draw()
plotPhi.save('figs/overlaid/phi', formats=formats)
...
# draw and save
plotPhi1.draw()
plotPhi1.save('figs/overlaid/phi1', formats=formats)
...
# set histograms
h_phiHXFwd = ROOT.TH1D('h_'+baseName+'Fwd_PhiHX', ';#varphi_{HX} (radian);# of dimuon', 30, -3.141592, 3.141592)
...
h_phiHXMid = ROOT.TH1D('h_'+baseName+'Mid_PhiHX', '', 30, -3.141592, 3.141592)
...
h_phiHXAllY = ROOT.TH1D('h_'+baseName+'AllY_PhiHX', '', 30, -3.141592, 3.141592)
...
# draw and save
plotPhiHX.draw()
plotPhiHX.save('figs/overlaid/phiHX', formats=formats)
...
# set histograms
h_phiCSFwd = ROOT.TH1D('h_'+baseName+'Fwd_PhiCS', ';#varphi_{CS} (radian);# of dimuon', 30, -3.141592, 3.141592)
...
h_phiCSMid = ROOT.TH1D('h_'+baseName+'Mid_PhiCS', '', 30, -3.141592, 3.141592)
...
h_phiCSAllY = ROOT.TH1D('h_'+baseName+'AllY_PhiCS', '', 30, -3.141592, 3.141592)
...
# draw and save
plotPhiCS.draw()
plotPhiCS.save('figs/overlaid/phiCS', formats=formats)
...
# draw and save
plotCosHX.draw()
plotCosHX.save('figs/overlaid/cosHX', formats=formats)
...
# draw and save
plotCosCS.draw()
plotCosCS.save('figs/overlaid/cosCS', formats=formats)
