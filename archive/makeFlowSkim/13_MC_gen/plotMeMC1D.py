...
# ====================== #
# get data TTree
f = TFile.Open('OniaFlowSkim.MC2023.AlgDefault.root')
myTree = f.Get('myTree')
...
# ===== Fwd mass ===== 
baseName = f'MC2023_{yRegion}_Mass'
...
# ===== Fwd pT ===== 
baseName = f'MC2023_{yRegion}_Pt'
myCanvas = TCanvas(baseName+yName, '', 800, 600)
leg = TLegend(0.8, 0.8, 0.9, 0.9)
legEntry = [legEntry1, legEntry2, '', ''] # Up to 4 lines
...
# ===== Fwd phi ===== 
baseName = f'MC2023_{yRegion}_Phi'
myCanvas = TCanvas(baseName+yName, '', 800, 600)
leg = TLegend(0.8, 0.8, 0.9, 0.9)
legEntry = [legEntry1, legEntry2, '', ''] # Up to 4 lines
...
# ===== Fwd phi HX ===== 
baseName = f'MC2023_{yRegion}_PhiHX'
myCanvas = TCanvas(baseName+yName, '', 800, 600)
leg = TLegend(0.8, 0.8, 0.9, 0.9)
legEntry = [legEntry1, legEntry2, '', ''] # Up to 4 lines
myHist = ROOT.TH1D('h_'+baseName, '', 30, -3.141592, 3.141592)
...
# ===== Fwd phi CS ===== 
baseName = f'MC2023_{yRegion}_PhiCS'
myCanvas = TCanvas(baseName+yName, '', 800, 600)
leg = TLegend(0.8, 0.8, 0.9, 0.9)
legEntry = [legEntry1, legEntry2, '', ''] # Up to 4 lines
myHist = ROOT.TH1D('h_'+baseName, '', 30, -3.141592, 3.141592)
...
# ===== Fwd cos HX ===== 
baseName = f'MC2023_{yRegion}_CosHX'
myCanvas = TCanvas(baseName+yName, '', 800, 600)
leg = TLegend(0.8, 0.8, 0.9, 0.9)
legEntry = [legEntry1, legEntry2, '', ''] # Up to 4 lines
...
# ===== Fwd cos CS ===== 
baseName = f'MC2023_{yRegion}_CosCS'
myCanvas = TCanvas(baseName+yName, '', 800, 600)
leg = TLegend(0.8, 0.8, 0.9, 0.9)
legEntry = [legEntry1, legEntry2, '', ''] # Up to 4 lines
myHist = ROOT.TH1D('h_'+baseName, '', 30, -1, 1)
