...
// MCType: Prompt(1), Nonprompt(2)
void onia_to_skim_pp_MC(string data_label_ = "test", int nevt = 10000, int MCType = 2, int kTrigSel = kTrigJpsipp, int hiHFBinEdge = -1)
{
  ...
  {
    // pp MC nonprompt
    TString filename = Form("/disk1/Oniatree/miniAOD/BtoJpsiJpsi_miniAOD94X_20Jun_v1.root");
  ...
  TFile *newfile;
  newfile = new TFile(Form("roots/OniaFlowSkim_%sTrig_pp_isMC%d_%s_%s.root", fTrigName[trigIndx].Data(), isMC, mc_type_label.Data(), data_label_.c_str()), "recreate");
