...
def draw_1d_hist_maps(h_num, h_den, legend1='', legend2='', x_title='', y_title='', save_name=''):
    ...
    leg3.AddEntry(h_den, 'Acceptance', 'ep')
    leg3.Draw()
...
def draw_2d_hist_maps(h_num, h_den, legend1='', legend2='', x_title='', y_title='', save_name=''):
    ...
    lt3.SetTextAlign(31)
    lt3.DrawLatexNDC(0.89, 0.80, 'Acceptance')
...
# ===== draw 1d plots ===== #
# y
draw_1d_hist_maps(h_num=h_y_lab_num_pp, h_den=h_y_lab_den_pp, legend1='', legend2='', x_title='|y|', y_title='', save_name='acc_y_lab_pp')

# cos
draw_1d_hist_maps(h_num=h_fwd_cos_lab_num_pp, h_den=h_fwd_cos_lab_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='', save_name='acc_fwd/cos_lab_pp')
draw_1d_hist_maps(h_num=h_fwd_cos_hx_num_pp, h_den=h_fwd_cos_hx_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='', save_name='acc_fwd/cos_hx_pp')
draw_1d_hist_maps(h_num=h_fwd_cos_cs_num_pp, h_den=h_fwd_cos_cs_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='', save_name='acc_fwd/cos_cs_pp')

draw_1d_hist_maps(h_num=h_mid_cos_lab_num_pp, h_den=h_mid_cos_lab_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='', save_name='acc_mid/cos_lab_pp')
draw_1d_hist_maps(h_num=h_mid_cos_hx_num_pp, h_den=h_mid_cos_hx_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='', save_name='acc_mid/cos_hx_pp')
draw_1d_hist_maps(h_num=h_mid_cos_cs_num_pp, h_den=h_mid_cos_cs_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='', save_name='acc_mid/cos_cs_pp')

# phi
draw_1d_hist_maps(h_num=h_fwd_phi_lab_num_pp, h_den=h_fwd_phi_lab_den_pp, legend1='', legend2='', x_title='#phi', y_title='', save_name='acc_fwd/phi_lab_pp')
draw_1d_hist_maps(h_num=h_fwd_phi_hx_num_pp, h_den=h_fwd_phi_hx_den_pp, legend1='', legend2='', x_title='#phi', y_title='', save_name='acc_fwd/phi_hx_pp')
draw_1d_hist_maps(h_num=h_fwd_phi_cs_num_pp, h_den=h_fwd_phi_cs_den_pp, legend1='', legend2='', x_title='#phi', y_title='', save_name='acc_fwd/phi_cs_pp')

draw_1d_hist_maps(h_num=h_mid_phi_lab_num_pp, h_den=h_mid_phi_lab_den_pp, legend1='', legend2='', x_title='#phi', y_title='', save_name='acc_mid/phi_lab_pp')
draw_1d_hist_maps(h_num=h_mid_phi_hx_num_pp, h_den=h_mid_phi_hx_den_pp, legend1='', legend2='', x_title='#phi', y_title='', save_name='acc_mid/phi_hx_pp')
draw_1d_hist_maps(h_num=h_mid_phi_cs_num_pp, h_den=h_mid_phi_cs_den_pp, legend1='', legend2='', x_title='#phi', y_title='', save_name='acc_mid/phi_cs_pp')

# pt
draw_1d_hist_maps(h_num=h_fwd_pT_lab_num_pp, h_den=h_fwd_pT_lab_den_pp, legend1='', legend2='', x_title='p_{T}', y_title='', save_name='acc_fwd/pT_lab_pp')
draw_1d_hist_maps(h_num=h_mid_pT_lab_num_pp, h_den=h_mid_pT_lab_den_pp, legend1='', legend2='', x_title='p_{T}', y_title='', save_name='acc_mid/pT_lab_pp')


# ===== draw 2d plots ===== #
# cos vs pT
draw_2d_hist_maps(h_num=h2_fwd_cos_pT_lab_num_pp, h_den=h2_fwd_cos_pT_lab_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='p_{T}', save_name='acc_fwd/2d_cos_pT_lab_pp')
draw_2d_hist_maps(h_num=h2_fwd_cos_pT_hx_num_pp, h_den=h2_fwd_cos_pT_hx_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='p_{T}', save_name='acc_fwd/2d_cos_pT_hx_pp')
draw_2d_hist_maps(h_num=h2_fwd_cos_pT_cs_num_pp, h_den=h2_fwd_cos_pT_cs_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='p_{T}', save_name='acc_fwd/2d_cos_pT_cs_pp')

draw_2d_hist_maps(h_num=h2_mid_cos_pT_lab_num_pp, h_den=h2_mid_cos_pT_lab_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='p_{T}', save_name='acc_mid/2d_cos_pT_lab_pp')
draw_2d_hist_maps(h_num=h2_mid_cos_pT_hx_num_pp, h_den=h2_mid_cos_pT_hx_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='p_{T}', save_name='acc_mid/2d_cos_pT_hx_pp')
draw_2d_hist_maps(h_num=h2_mid_cos_pT_cs_num_pp, h_den=h2_mid_cos_pT_cs_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='p_{T}', save_name='acc_mid/2d_cos_pT_cs_pp')
...
draw_2d_hist_maps(h_num=h2_fwd_cos_phi_lab_num_pp, h_den=h2_fwd_cos_phi_lab_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='#phi', save_name='acc_fwd/2d_cos_phi_lab_pp')
draw_2d_hist_maps(h_num=h2_fwd_cos_phi_hx_num_pp, h_den=h2_fwd_cos_phi_hx_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='#phi', save_name='acc_fwd/2d_cos_phi_hx_pp')
draw_2d_hist_maps(h_num=h2_fwd_cos_phi_cs_num_pp, h_den=h2_fwd_cos_phi_cs_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='#phi', save_name='acc_fwd/2d_cos_phi_cs_pp')
...
for idx in (1,2,3,4,5,6):
    ...
    draw_2d_hist_maps(h_num=h2_fwd_cos_phi_lab_num_pp, h_den=h2_fwd_cos_phi_lab_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='#phi', save_name='acc_fwd/2d_cos_phi_lab_pp_' + name_tag)
    draw_2d_hist_maps(h_num=h2_fwd_cos_phi_hx_num_pp, h_den=h2_fwd_cos_phi_hx_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='#phi', save_name='acc_fwd/2d_cos_phi_hx_pp_' + name_tag)
    draw_2d_hist_maps(h_num=h2_fwd_cos_phi_cs_num_pp, h_den=h2_fwd_cos_phi_cs_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='#phi', save_name='acc_fwd/2d_cos_phi_cs_pp_' + name_tag)
...
draw_2d_hist_maps(h_num=h2_mid_cos_phi_lab_num_pp, h_den=h2_mid_cos_phi_lab_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='#phi', save_name='acc_mid/2d_cos_phi_lab_pp')
draw_2d_hist_maps(h_num=h2_mid_cos_phi_hx_num_pp, h_den=h2_mid_cos_phi_hx_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='#phi', save_name='acc_mid/2d_cos_phi_hx_pp')
draw_2d_hist_maps(h_num=h2_mid_cos_phi_cs_num_pp, h_den=h2_mid_cos_phi_cs_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='#phi', save_name='acc_mid/2d_cos_phi_cs_pp')
...
for idx in (1,2,3,4,5):
    ...
    draw_2d_hist_maps(h_num=h2_mid_cos_phi_lab_num_pp, h_den=h2_mid_cos_phi_lab_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='#phi', save_name='acc_mid/2d_cos_phi_lab_pp_' + name_tag)
    draw_2d_hist_maps(h_num=h2_mid_cos_phi_hx_num_pp, h_den=h2_mid_cos_phi_hx_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='#phi', save_name='acc_mid/2d_cos_phi_hx_pp_' + name_tag)
    draw_2d_hist_maps(h_num=h2_mid_cos_phi_cs_num_pp, h_den=h2_mid_cos_phi_cs_den_pp, legend1='', legend2='', x_title='cos#theta', y_title='#phi', save_name='acc_mid/2d_cos_phi_cs_pp_' + name_tag)