...
# make an instance
fit = McMassFit(
    ptLow=changeThisNumber, ptHigh=changeThisNumber,
    yLow=changeThisNumber, yHigh=changeThisNumber,
    cLow=changeThisNumber, cHigh=changeThisNumber,
...
if fit.pdfType == 'doubleCB':
  fit.initVar('N_Jpsi', 300000, 200000, 1000000)
