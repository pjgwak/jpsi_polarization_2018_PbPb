void test_comp_eff(){
  ...
  gStyle->SetOptFit(0);
  TFile *f1 = new TFile("mc_eff_vs_pt_cent_20_to_120_rap_prompt_pbpb_psi2s_PtW1_tnp1_SysUp0_20220119.root","READ");
  TFile *f2 = new TFile("mc_eff_vs_pt_cent_20_to_120_rap_prompt_pbpb_psi2s_PtW1_tnp1_SysUp1_20220119.root","READ");
  TFile *f3 = new TFile("mc_eff_vs_pt_cent_20_to_120_rap_prompt_pbpb_psi2s_PtW1_tnp1_SysUp2_20220119.root","READ");

  TH1F *h1 = (TH1F*)f1->Get("mc_eff_vs_pt_TnP1_PtW1_cent_20_to_120_absy0_1p2");
  TH1F *h2 = (TH1F*)f2->Get("mc_eff_vs_pt_TnP1_PtW1_cent_20_to_120_absy0_1p2");
  TH1F *h3 = (TH1F*)f3->Get("mc_eff_vs_pt_TnP1_PtW1_cent_20_to_120_absy0_1p2");
  TH1F *h4 = (TH1F*)f1->Get("mc_eff_vs_pt_TnP1_PtW1_cent_20_to_120_absy1p8_2p4");
  TH1F *h5 = (TH1F*)f2->Get("mc_eff_vs_pt_TnP1_PtW1_cent_20_to_120_absy1p8_2p4");
  ...
  c1->SaveAs("plot_comp_efficiency_comp.png");
