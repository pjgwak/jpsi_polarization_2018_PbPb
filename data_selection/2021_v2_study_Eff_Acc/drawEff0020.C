void drawEff0020(){
    ...
    TFile *in1 = new TFile("mc_eff_vs_pt_cent_0_to_20_rap_prompt_pbpb_psi2s_PtW1_tnp1_20220125.root","READ");
    ...
    TH1F *hEff1_pt1 = (TH1F*)in1->Get("mc_eff_vs_pt_TnP1_PtW1_cent_0_to_20_absy0_2p4");
    TH1F *hEff1_pt2 = (TH1F*)in1->Get("mc_eff_vs_pt_TnP1_PtW1_cent_0_to_20_absy0_1p2");
    TH1F *hEff1_pt3 = (TH1F*)in1->Get("mc_eff_vs_pt_TnP1_PtW1_cent_0_to_20_absy1p2_1p6");
    TH1F *hEff1_pt4 = (TH1F*)in1->Get("mc_eff_vs_pt_TnP1_PtW1_cent_0_to_20_absy1p6_1p8");
    TH1F *hEff1_pt5 = (TH1F*)in1->Get("mc_eff_vs_pt_TnP1_PtW1_cent_0_to_20_absy1p8_2p4");
    ...
    TLegend *lg1 = new TLegend(0.55,0.17,0.73,0.42);
    lg1->SetFillStyle(0);
    lg1->SetFillColor(0);
    lg1->SetBorderSize(0);
    lg1->SetTextSize(0.035);
    lg1->AddEntry(hEff1_pt3,"|y|: 0.0-1.2, 0-10 %","lep");
    lg1->AddEntry(hEff1_pt4,"|y|: 1.2-1.6, 0-10 %","lep");
    lg1->AddEntry(hEff1_pt5,"|y|: 1.6-1.8, 0-10 %","lep");
    lg1->AddEntry(hEff1_pt6,"|y|: 1.8-2.4, 0-10 %","lep");
    ...
    c1->SaveAs("eff_total_y_0010.png");


    c1->cd();
    hEff1_pt3->GetXaxis()->SetRangeUser(0.0,50.0);
    hEff1_pt3->GetYaxis()->SetRangeUser(0.0,1.2);
    hEff1_pt3->GetYaxis()->SetTitle("Reconstruction Efficiency");
    hEff1_pt3->GetXaxis()->SetTitle("p_{T} (GeV/c)");
    hEff1_pt3->GetYaxis()->CenterTitle();
    hEff1_pt3->GetXaxis()->CenterTitle();
    hEff1_pt3->Draw("E");
    ...
    c1->SaveAs("eff_psi2s_total_pt_0010.png");
    c1->SaveAs("eff_psi2s_total_pt_0010.pdf");

 
    TFile *out = new TFile("eff_psi2s_pbpb_ptwgt1_0010.root","RECREATE");
    out->cd();
